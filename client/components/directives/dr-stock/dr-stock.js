(function(){
  ...
  .directive('drStock', ['$interval', function($interval){
    var o = {};

    o.restrict    = 'A';
    o.templateUrl = '/components/directives/dr-stock/dr-stock.html';
    o.scope = {symbol:'@'};
    ...
    o.controller = ['$scope', 'StockApi', function($scope, StockApi){
      ...
      $scope.id = $interval(getQuote, 20000);
      getQuote();
    }];
    return o;
  }]);
